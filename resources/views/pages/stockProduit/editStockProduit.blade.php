...
@section('titre')
    <span>Modifier le stock du produit</span>
@endsection
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('stockProduit.update', $stock->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <a href="{{ route('stockProduit.list') }}" class="btn btn-secondary">Retour</a>
                    </div>
